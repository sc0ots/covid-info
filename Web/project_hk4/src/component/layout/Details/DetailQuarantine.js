...
class DetailQuarantine extends Component {
    constructor() {
        super()
        this.state = {
            name: "",
    ...
    render() {
        ...
        return (
            <>
                <Header
                    as='h1'
                    content='Details quarantine'
                    subheader=''
                />
                <Descriptions title="Quanrantine" labelStyle={{ fontWeight: "bold", fontSize: "16px" }} contentStyle={{ fontSize: "16px" }} layout="horizontal">
...
export default DetailQuarantine;
